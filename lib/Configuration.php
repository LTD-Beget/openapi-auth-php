...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.beget.com';
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/v1.2.1/PHP';
    ...
    public static function toDebugReport()
    {
        ...
        $report .= '    The version of the OpenAPI document: v1.2.1' . PHP_EOL;
        $report .= '    SDK Package Version: v1.2.1' . PHP_EOL;
